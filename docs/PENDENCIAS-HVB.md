...
| Verificação funcional posterior | Por pedido de 23/09, usar apenas checks de integridade durante desenvolvimento; testes já existentes preservados | Reexecutar fluxos quando solicitado; restauração/logout/troca de abas e alterações finais do MVP 10 ainda exigem conferência funcional |
