...
| Contratos de backend solicitados pelo frontend MVP 11 | RESOLVIDA a falta de leitura de permissões por papel, onboarding atômico, entrada atômica de lote novo e busca server-side de pacientes; 46 testes locais aprovados; detalhes em CONTRATOS-BACKEND-MVP11.md | Frontend ainda precisa consumir e testar esses contratos. Catálogo permanece global na organização; login humano é proposta futura, ainda não implementado. Lote existente/recipiente e busca por identificador legado mantêm limites documentados |
