...
5. **Próximo C4:** financeiro de aquisição/despesas em simulação, com obrigação identificada e pagamento/reversão explícitos, separado do recebimento físico.
6. **C5:** contrato e fluxo de terminal simulado sob SISTEMA, sem editar a pasta Terminal. Depois, fechar as faltas de vínculos indicadas na matriz antes de declarar o núcleo concluído.
